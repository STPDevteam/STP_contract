...
library MessagesAndCodes {
    string public constant EMPTY_MESSAGE_ERROR = "Message cannot be empty";
    string public constant CODE_RESERVED_ERROR = "Given code is already points to a message";
